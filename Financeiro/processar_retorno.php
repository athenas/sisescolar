       ...
       <div id="container">
            ...
            <div id="content">
                ...
                <form method="post" action="processado_retorno.php">
                	...
                	<tr><td>nosso_numero</td><td>Vencimento</td><td>Movimento</td><td>valor</td><td>Local Pagamento</td><td>Forma Pagamento</td></td><td>Vlr Pago</td><td>Acrescimos</td><td>Descontos</td><td>Abatimentos</td><td>Vlr Tarifa</td><td>Vlr Liquido</td></tr>
                	<?php	
                		session_start();
						...
						while(!feof($arquivo)){
							...
							if (substr($linha, 13,1) == "T"){
								...
								switch (substr($codret,0,2)) {
									case '02': $local = 'Casas Lotericas';
										break;
									case '03': $local = 'Liquidação no próprio Banco';
										break;
									case '04': $local = 'Compensação Eletrônica';
										break;
									case '05': $local = 'Compensação Convencional';
										break;
									case '06': $local = 'Outros Canais';
										break;
									case '07': $local = 'Correspondente Não Bancário';
										break;
									case '08': $local = 'Em Cartório';
										break;
									
								}
								switch (substr($codret,4,2)) {
									case '01': $formaPgto = 'Dinheiro';
										break;
									case '02': $formaPgto = 'Cheque';
										break;
                   ...
                   <button >Processar</button>
                    <input name='nome_arquivo' type='hidden' value='<?php echo $_SESSION['filename']?>' />
                </form>
             </div>
