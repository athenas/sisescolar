       ...
       <div id="container">
            ...
            <div id="content">
                ...
                <form method="post">
                	...
                	<tr><td>Nosso Numero</td><td>Status</td><td>Valor Com Desconto</td><td>Valor Pago</td></tr>
                	<?php	
                		session_start();
						...
						while(!feof($arquivo)){
							...
							if (substr($linha, 13,1) == "U"){
								...
								echo "<tr><td>$nosso_numero</td><td>"
									.$resultado[0]['resposta']."</td><td>"
									.number_format($resultado[0]['minimo'],"2",",",".")."</td><td>"
									.number_format($resultado[0]['pago'],"2",",",".")."</td></tr>";
