                     ...
                     <div style="height:440px">
   					 	...
   					 	<select id="serieirmao" name="serieirmao">
								...
								if ($_SESSION['serie'] <= 0) { echo "<option value='0'>PRE II</option>;}
	   					 		...
	   					 		if ($_SESSION['serie'] <= 4) { echo "<option value='4'>ENSINO FUNDAMENTAL I - 4&deg; Ano </option>"; }
	   					 		if ($_SESSION['serie'] <= 5) { echo "<option value='5'>ENSINO FUNDAMENTAL I - 5&deg; Ano </option><"; }
	   					 		if ($_SESSION['serie'] <= 6) { echo "<option value='6'>ENSINO FUNDAMENTAL II - 6&deg; Ano</option>"; }
	   					 		if ($_SESSION['serie'] <= 7) { echo "<option value='7'>ENSINO FUNDAMENTAL II - 7&deg; Ano</option>"; }
	   					 		if ($_SESSION['serie'] <= 8) { echo "<option value='8'>ENSINO FUNDAMENTAL II - 8&deg; Ano</option>"; }
	   					 		if ($_SESSION['serie'] <= 9) { echo "<option value='9'>ENSINO FUNDAMENTAL II - 9&deg; Ano</option>"; }
	   					 		if ($_SESSION['serie'] <= 10) { echo "<option value='10'>ENSINO MEDIO - 1&deg; Ano</option>"; }
	   					 		if ($_SESSION['serie'] <= 11) { echo "<option value='11'>ENSINO MEDIO - 2&deg; Ano</option>"; }
	   					 		if ($_SESSION['serie'] <= 12) { echo "<option value='12'>ENSINO MEDIO - 3&deg; Ano</option>"; }
							?>
   					 	</select>
   					 	<br/>
   					 	<label for="nomeirmao" style='width:120px;margin-top:5px'>Nome do Irmao: </label>
   					 	<input id="nomeirmao" name="nomeirmao" size="50" />
   					 	<input id="matirmao" name='matirmao' type='hidden' />
