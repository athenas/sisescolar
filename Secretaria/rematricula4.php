                ...
                <form id="frm1" method="post" action="precontrato.php">
                     <p><h2>ReMatricula 4/5</h2></p>
                        <div id="dialog" title="Aviso"></div>
                         ...
                         <label style='margin-left:120px'>Dt. Nasc.</label><input style='margin-left:-20px' type="text" name="aluno_dtnasc" id="aluno_dtnasc"  size="12"  value="<?php echo date("d/m/Y",strtotime($dados_aluno['DtNascimento'])); ?>"/>
                         <br/>
                     ...
                     <div id="Dados_responsavel"  style="height:345px;overflow: auto">
                         ...
                         <label style='margin-left:26px'>Dt. Nasc.</label><input style='margin-left:-20px' type="text" name="resp_dtnasc" id="resp_dtnasc"  size="12" value="<?php echo  date("d/m/Y",strtotime($dados_aluno['DtNascimentoResp']));?>"/>
                         <br/>
