<?php
	...
	switch ($registro['nSerieIrmao']) {
		case 1: $irmao_serie = 'ENSINO FUNDAMENTAL I -  1&deg; ANO';
			break;
		case 2: $irmao_serie = 'ENSINO FUNDAMENTAL I -  2&deg; ANO';
			break;
		case 3: $irmao_serie = 'ENSINO FUNDAMENTAL I -  3&deg; ANO';
			break;
		case 4: $irmao_serie = 'ENSINO FUNDAMENTAL I -  4&deg; ANO';
			break;
		case 5: $irmao_serie = 'ENSINO FUNDAMENTAL I -  5&deg; ANO';
			break;
		case 6: $irmao_serie = 'ENSINO FUNDAMENTAL II -  6&deg; ANO';
			break;
		case 7: $irmao_serie = 'ENSINO FUNDAMENTAL II -  7&deg; ANO';
			break;
		case 8: $irmao_serie = 'ENSINO FUNDAMENTAL II -  8&deg; ANO';
			break;
		case 9: $irmao_serie = 'ENSINO FUNDAMENTAL II -  9&deg; ANO';
			break;
		case 10: $irmao_serie = 'ENSINO MEDIO -  1&deg; ANO';
			break;
		case 11: $irmao_serie = 'ENSINO MEDIO -  2&deg; ANO';
			break;
		case 12: $irmao_serie = 'ENSINO MEDIO -  3&deg; ANO';
			break;
