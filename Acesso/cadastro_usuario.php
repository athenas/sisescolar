            ...
            <div id="content">
                ...
                <form name="frm1" id="frm1" method="post" action="update_usuario.php">
                   ...
                   <div id="geral" style='height:415px;padding-left: 5px;overflow: auto '>
                     	<input id="usuario_codigo" name="usuario_codigo" type="hidden" value="<?php echo $_REQUEST['codigo']; ?>" />
                     	<label>Login</label>
                 	 	<input id="usuario_login" name="usuario_login"  size="12" value="<?php echo $registro['cLogin']; ?>" />
                 	 	<br/>
                 	 	<label style="margin-top:5px">Nome</label>
          				<input id="usuario_nome" name="usuario_nome" size="42" value="<?php echo $registro['cNmUsuario']; ?>"/>
          				<br/>
                 	 	<label style="margin-top:5px">Perfil</label>
          				<select id="usuario_perfil" name="usuario_perfil">
          				...
          				<input id="usuario_senha" name="usuario_senha" type="password" size="12"/>
          				<label style="margin-top:5px">Confirmacao</label>
          				<input id="usuario_confirmacao" name="usuario_confirmacao" type="password" size="12"/>
          				<br/>
