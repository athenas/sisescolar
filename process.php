...
<body>
       <div id="container">
            ...
            <div id="content">
                ...
                <form method="post" >
                     <p><h2>CONSULTA INSS - HISTORICO</h2></p>
                     	<div id="tabs">
						<?php
							echo "<ul>";
						...
						?>
                         ...
                         <br/><br/>
                          <a class="sbtn">Consultar</a>
                           <span id='descontos'></span>
                         <br/>
                         <input type="hidden" id="metodo" value="<?php echo $_REQUEST['metodo']; ?>" />
                          <input type="hidden" id="param1" value="<?php echo $_REQUEST['matricula']; ?>" />
