...
<p class='paragrafo' style="font-family: Courier">
	Referente:<br/>
	<table style="margin-left: 30px; border-style:solid;border-width: 1px">
		<thead>
			<tr >
...
<p class='paragrafo'>
	A falta de pagamento implicará o relacionamento de sua dívida para exame de nosso setor jurídico e posterior cobrança judicial executiva.
</p>
<p class='paragrafo'>
...
<br/>
<p class='paragrafo'>
	<b>Elaine Santos</b><br/>
	<span style="margin-left: 36px;">Depto de cobrança</span><br/>
	<span style="margin-left: 36px;">Instituto Educacional JR LTDA</span>
