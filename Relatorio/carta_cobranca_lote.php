...
<body>
       <div id="container">
            ...
            <div id="content">
                ...
                <form method="post" action="carta_cobranca_lote_rel.php" target="_blank">
                	<div id="tabs">
                     		<ul>
                   ...
                   <div id="geral" style='height:415px;padding-left: 5px;overflow: auto '>
             	   <fieldset style="padding-top:15px; padding-left:5px; padding-bottom:15px">
					   ...
					   <input id="data_inicio" name="data_inicio" type="text" size='12' value=''/> 
					   <label style="margin-top:5px">Data Inicio</label>
					   <input id="data_fim" name="data_fim" type="text" size='12' value=''/>   	
				   </fieldset>
				    <fieldset style="padding-top:15px; padding-left:5px; padding-bottom:15px">
	             	   <legend style="margin-left:10px">Valores em aberto entre</legend>
	             	   <label >Valor Inicio</label>
					   <input style="text-align: right" id="valor_inicio" name="valor_inicio" type="text" size='12' value=''/> 
					   <label style="margin-top:5px">Valor Fim</label>
					   <input style="text-align: right"  id="valor_fim" name="valor_fim" type="text" size='12' value=''/>   	
				   </fieldset>
				   <br/>
