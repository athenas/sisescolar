...
<body>
       <div id="container">
            ...
            <div id="content">
                ...
                <form name="frm1" id="frm1" method="post" action="carta_cobranca_rel.php" target="_blank">
                   ...
                   <div id="geral" style='height:415px;padding-left: 5px;overflow: auto '>
                 	 	...
                 	 	<label style="width: 115px">CPF</label>
                 	 	<input type="text" size="15" name="cpf" id="cpf" />
                 	 	<img src="../image/search-icon.png" name="btnpesq" id="btnpesq" height="15px" >
                 	 	<br/>
                 	 	<label style="margin-top:5px;width: 115px">Nome</label>
                 	 	<input type="text" size="40" name="pessoa_nome" id="pessoa_nome" />
                 	 	<br/>
                 	 	<label style="margin-top:5px;width: 115px">Boletos em Aberto</label>
                 	 	<input type="text" size="12" name="boleto_abt" id="boleto_abt" value="1" style="text-align:right"/>
                 	 	<br/>
                 	 	<label style="margin-top:5px;width: 115px">Menor Vcto</label>
                 	 	<input type="text" size="12" name="menor_vcto" id="menor_vcto" style="text-align:right"/>
          
                 	 	<br/>
                 	 	<label style="margin-top:5px;width: 115px">Mario Vcto</label>
                 	 	<input type="text" size="12" name="maior_vcto" id="maior_vcto" value="" style="text-align:right" />
                 	 	<br/>
                 	 
                 	 	<label style="margin-top:5px;width: 115px">Valor Total</label>
                 	 	<input type="text" size="12" name="valor_total" id="valor_total" value="0,00" style="text-align:right" />
